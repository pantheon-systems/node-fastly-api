...
export default class Stats {
  static instantiate({ jsonRequest, formRequest }: { jsonRequest: AxiosInstance; formRequest: AxiosInstance }): StatsWorker {
    return new StatsWorker({ jsonRequest, formRequest });
  }
}
...
class StatsWorker extends GenericEndpoint {
  namespace: string = 'Stats';
  ...
  readServiceStats(service_id: string, field: string, params: Params = {
    to: null,
    from: null,
    by: null,
    region: null
  ...
  readUsageByService(params: Params = {
    to: null,
    from: null,
    by: null,
    region: null
  ...
  readUsageByMonth(params: Params = {
